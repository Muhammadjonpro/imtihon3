...
let elBtn1 = document.querySelector(".button");
let elBtn2 = document.querySelector(".button1");
let elBtn3 = document.querySelector(".button2");
let elBtnClean = document.querySelector(".button__clean");
